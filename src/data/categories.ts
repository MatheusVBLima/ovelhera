...
export const categories: Record<string, Category> = {
  ...
  melhorSheik: {
    ...
    options: ['Vaas', 'Picanha na chapa', 'LokoGamer', 'Xaim_', 'Criminal'],
  },
  pioresPapagaio: {
  ...
  melhorMulher: {
    ...
    options: ['Jessika', 'Kikira02', 'Carol'],
  },
  melhorMod: {
    title: 'Mod do ano',
    description: 'Qual foi o melhor mod do ano?',
    options: ['Madru', 'Calumbr', 'Vinykrugger', 'XY'],
  },
  melhorViewer: {
    title: 'Viewer do ano',
  ...
  melhorAcontecimento: {
    ...
    options: [
      ...
      'Ovelha falando o que pensa sobre sionistas e afins',
  ...
  melhorCorteDeCabelo: {
    ...
    options: ['Chocalho', 'Abacaxi', 'Bigorna'],
  },
  melhorCamisa: {
    title: 'Melhor Camisa',
